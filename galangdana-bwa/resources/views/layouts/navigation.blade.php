        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('admin.fundraiser.index')" :active="request()->routeIs('admin.fundraiser.index')">
                        {{ __('Fundraiser') }}
                    </x-nav-link>
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            ...
                            <div class="flex items-center gap-3"> <img src="{{Storage::url(Auth::user()->avatar)}}" class="w-[30px] h-[30px] rounded-full" alt=""> {{ Auth::user()->name }}</div>
